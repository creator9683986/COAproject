...
static const char* PromoService_method_names[] = {
  ...
  "/promo.PromoService/ClickPromoCode",
  "/promo.PromoService/CommentPromoCode",
};
...
PromoService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_ClickPromoCode_(PromoService_method_names[5], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CommentPromoCode_(PromoService_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status PromoService::Stub::ClickPromoCode(::grpc::ClientContext* context, const ::promo::ClickPromoCodeRequest& request, ::promo::PromoCode* response) {
  return ::grpc::internal::BlockingUnaryCall< ::promo::ClickPromoCodeRequest, ::promo::PromoCode, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_ClickPromoCode_, context, request, response);
}

void PromoService::Stub::async::ClickPromoCode(::grpc::ClientContext* context, const ::promo::ClickPromoCodeRequest* request, ::promo::PromoCode* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::promo::ClickPromoCodeRequest, ::promo::PromoCode, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_ClickPromoCode_, context, request, response, std::move(f));
}

void PromoService::Stub::async::ClickPromoCode(::grpc::ClientContext* context, const ::promo::ClickPromoCodeRequest* request, ::promo::PromoCode* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_ClickPromoCode_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::promo::PromoCode>* PromoService::Stub::PrepareAsyncClickPromoCodeRaw(::grpc::ClientContext* context, const ::promo::ClickPromoCodeRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::promo::PromoCode, ::promo::ClickPromoCodeRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_ClickPromoCode_, context, request);
}

::grpc::ClientAsyncResponseReader< ::promo::PromoCode>* PromoService::Stub::AsyncClickPromoCodeRaw(::grpc::ClientContext* context, const ::promo::ClickPromoCodeRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncClickPromoCodeRaw(context, request, cq);
  result->StartCall();
  return result;
}

::grpc::Status PromoService::Stub::CommentPromoCode(::grpc::ClientContext* context, const ::promo::CommentPromoCodeRequest& request, ::promo::PromoCode* response) {
  return ::grpc::internal::BlockingUnaryCall< ::promo::CommentPromoCodeRequest, ::promo::PromoCode, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_CommentPromoCode_, context, request, response);
}

void PromoService::Stub::async::CommentPromoCode(::grpc::ClientContext* context, const ::promo::CommentPromoCodeRequest* request, ::promo::PromoCode* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::promo::CommentPromoCodeRequest, ::promo::PromoCode, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_CommentPromoCode_, context, request, response, std::move(f));
}

void PromoService::Stub::async::CommentPromoCode(::grpc::ClientContext* context, const ::promo::CommentPromoCodeRequest* request, ::promo::PromoCode* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_CommentPromoCode_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::promo::PromoCode>* PromoService::Stub::PrepareAsyncCommentPromoCodeRaw(::grpc::ClientContext* context, const ::promo::CommentPromoCodeRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::promo::PromoCode, ::promo::CommentPromoCodeRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_CommentPromoCode_, context, request);
}

::grpc::ClientAsyncResponseReader< ::promo::PromoCode>* PromoService::Stub::AsyncCommentPromoCodeRaw(::grpc::ClientContext* context, const ::promo::CommentPromoCodeRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncCommentPromoCodeRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
PromoService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      PromoService_method_names[5],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< PromoService::Service, ::promo::ClickPromoCodeRequest, ::promo::PromoCode, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](PromoService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::promo::ClickPromoCodeRequest* req,
             ::promo::PromoCode* resp) {
               return service->ClickPromoCode(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      PromoService_method_names[6],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< PromoService::Service, ::promo::CommentPromoCodeRequest, ::promo::PromoCode, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](PromoService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::promo::CommentPromoCodeRequest* req,
             ::promo::PromoCode* resp) {
               return service->CommentPromoCode(ctx, req, resp);
             }, this)));
}
...
::grpc::Status PromoService::Service::ClickPromoCode(::grpc::ServerContext* context, const ::promo::ClickPromoCodeRequest* request, ::promo::PromoCode* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status PromoService::Service::CommentPromoCode(::grpc::ServerContext* context, const ::promo::CommentPromoCodeRequest* request, ::promo::PromoCode* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
